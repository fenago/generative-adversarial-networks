...
a higher score indicates a lower-quality image and the relationship may be linear. The authors
 ...
 score show that lower FID scores correlate with better-quality images when systematic
...
In this part you will discover loss functions used to train generative adversarial networks. After
reading the chapters in this part, you will know:

- Details of standard and alternate GAN loss functions and their differences when compared
directly(Chapter 14).
